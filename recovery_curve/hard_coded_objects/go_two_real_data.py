...
pid_iterator = gd.filtered_pid_iterator(ps.set_hard_coded_key_dec(gd.filtered_pid_iterator,'surgpids')(gd.all_ucla_pid_iterator(), gd.bin_f(gd.ucla_treatment_f(),ps.equals_bin([gd.ucla_treatment_f.surgery]))), gd.is_good_pid())
