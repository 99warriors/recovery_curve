...
id_to_x_s_f = gd.an_id_to_x_s_f(dim)
...
param = set_hard_coded_key_dec(ps.keyed_dict, 'ABC_n2p1p2_phis_05')({\
...
data = gd.simulated_get_data_f(param, pops, id_to_x_s_f, sim_times, noise_f, seed)(pid_iterator)
